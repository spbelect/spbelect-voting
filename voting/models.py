...
class Question(models.Model):
    ...
    max_replies_number = \
        models.SmallIntegerField(verbose_name=
                                 u'максимальное количество ответов',
...
class Answer(models.Model):
    ...
    photo = models.ImageField(upload_to='photo', verbose_name=u'фото',
                              height_field='height', width_field='width',
                              null=True, blank=True)
    title = models.TextField(verbose_name=u'заголовок')
    text = models.TextField(verbose_name=u'текст', null=True, blank=True)
    height = models.SmallIntegerField(verbose_name=u'высота',
                                      null=True, blank=True)
    width = models.SmallIntegerField(verbose_name=u'ширина',
                                     null=True, blank=True)
...
class UserReply(models.Model):
    ...
    user = models.ForeignKey(User, related_name='user_replies',
                             db_column='user_id')
    question = models.ForeignKey(Question, related_name='user_replies',
...
class ReplyData(models.Model):
    key = models.TextField(primary_key=True)
    reply = models.ForeignKey(Reply, related_name='reply_data',
                              db_column='reply_key')
    answer = models.ForeignKey(Answer, related_name='reply_data',
                               db_column='answer_id', null=True)
