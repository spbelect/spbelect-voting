...
urlpatterns += patterns('voting.views',
    #(r'^index/$|^$', 'index'),
    #(r'^index/$|^$',
    #  TemplateView.as_view(template_name='voting_stopped.html')),
    (r'^index/$|^$', TemplateView.as_view(template_name='results.html')),
    #(r'^question-list/$', 'question_list'),
    (r'^question-list/$', RedirectView.as_view(url='/', permanent=False)),
    #(r'^question/(?P<id>\d+)$', 'question'),
    (r'^question/(?P<id>\d+)$', RedirectView.as_view(url='/',
                                                     permanent=False)),
